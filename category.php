...
<!-- Loader of the page end-->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-9">
                            ...
                            if(isset($_POST['addCart1'])){
                                if(isset($_SESSION['cartDetails'])){
                                    ...
                                    if(!in_array($_GET['product_id'],$outputValues)){
                                        ...
                                        $query3 = "SELECT * FROM featuredproducts where fproduct_cat_id = $id";
                        ...
                        else{ $page_1 = ($page*10)-10; }

                            $query = "SELECT * FROM featuredproducts where fproduct_cat_id = $product_cat_id";
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-md-8">
                                     ...
                                     <div class="allp-HorizontalCard-ratBuy">
                                         ...
                                         <form class="" action="category.php?action=add&product_id=<?php echo $product_id; ?>" method="post">
        ...
        <ul class="list-inline mx-auto justify-content-center">
            ...
            <?php
            $post_query_count = "SELECT * FROM featuredproducts where fproduct_cat_id = $product_cat_id";
            ...
            $count = ceil($count/10);
              for ($i=1; $i <= $count; $i++) {
                  ...
                  if($i == $page){
                    echo "<li class='list-inline-item page-item'><a class='page-link active_link ' href='category.php?page={$i}'>{$i}</a></li>";
                  }
                  else {
                      echo "<li class='list-inline-item page-item pageitem '><a class='page-link' href='category.php?page={$i}'>{$i}</a></li>";
                  }
